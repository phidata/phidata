...
<!-- END SIDEBAR -->
    ...
    <div class="page-content-wrapper">
        ...
        <!-- END PAGE BREADCRUMB -->
            ...
            margin-bottom: 40px;">该账号已被冻结.</div>
                </div>
            </div>
            </div>
            <div class="row">
...
<div class="page-footer">
    <div class="page-footer-inner"> 2016 &copy; Ochat.
        <a href="" title="Olife Organzation" target="_blank">Orange Life!</a>
    </div>
